...
public class ThemeService
{
    ...
    public async Task SetThemeAsync(string themeUrl)
    {
        if (themeUrl.StartsWith("_content/DevExpress.Blazor.Themes/_content/DevExpress.Blazor.Themes/"))
            themeUrl = themeUrl.Replace("_content/DevExpress.Blazor.Themes/_content/DevExpress.Blazor.Themes/",
                "_content/DevExpress.Blazor.Themes/");
    ...
    public async Task<string> GetSavedThemeAsync()
    {
        ...
        {
            theme = theme.Replace("_content/DevExpress.Blazor.Themes/_content/DevExpress.Blazor.Themes/",
                "_content/DevExpress.Blazor.Themes/");
