...
namespace BlazingGidde.Server.Data.Migration
{
    ...
    [Migration("20241119184401_PersonModels")]
    partial class PersonModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Address", b =>
                {
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.AddressType", b =>
                {
                    b.Property<int>("AddressTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Email", b =>
                {
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.EmailType", b =>
                {
                    b.Property<int>("EmailTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Person", b =>
                {
                    b.Property<int>("PersonID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.PersonProfile", b =>
                {
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.PersonType", b =>
                {
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Phone", b =>
                {
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.PhoneType", b =>
                {
                    b.Property<int>("PhoneTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Address", b =>
                {
                    b.HasOne("BlazingGidde.Shared.Models.Person.AddressType", "AddressType")
                        .WithMany("Addresses")
                        .HasForeignKey("AddressTypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazingGidde.Shared.Models.Person.Person", "Person")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Email", b =>
                {
                    b.HasOne("BlazingGidde.Shared.Models.Person.EmailType", "EmailType")
                        .WithMany("Emails")
            ...
            modelBuilder.Entity("BlazingGidde.Shared.Models.Person.Phone", b =>
                {
                    ...
                    b.HasOne("BlazingGidde.Shared.Models.Person.PhoneType", "PhoneType")
                        .WithMany("Phones")
