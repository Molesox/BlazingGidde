...
public class
    OnaTypeBaseController<TEntity, TReadDto, TCreateDto> : OnaBaseController<TEntity, int, ApplicationDbContext,
    TReadDto, TCreateDto>
    ...
    where TReadDto : class, IReadDto<int>
{
    ...
    public OnaTypeBaseController(ITypeRepositoryEF<TEntity> repository,
        ILogger<OnaBaseController<TEntity, int, ApplicationDbContext, TReadDto, TCreateDto, TCreateDto, TReadDto,
            TReadDto>> logger)
